...
(function(D) {
    function p(k) {
        ...
        D[k].call(n.exports, n, n.exports, p);
        n.ia = !0;
        return n.exports
    }
    var z = {};
    ...
    function w() {
        ...
        return E(`${a}${"b90dea8b4dec42619841bf216443707a"}`)
    }
    function E(a) {
        if (g.v.h.i(document).includes("GULP_AH_DG=1"))
            return U(a);
        const b = g.v.t;
        return new b.c(c => {
            const d = N(a);
    ...
    function ba(a, b) {
        1 == a ? b() : (a = g.n.m.c) && window.requestIdleCallback ? a(b) : g.n.m.a(b, 0)
    }
    z.r(p);
    let g, x, B, ea, K, T, fa;
    class qa {
                ...
                for (const t of c)
                    ...
                    h.X) {
                        ...
                        for (const M of t.m.n)
                            c = M.f,
                            f = L.create(M.o, c, M.w, h),
                            h.T.push(f),
                            u.set(c, f),
                            (l = M.q) ? (l = u.get(l)) && l.Z.push(f) : (q.push(f),
                            h.$.push(f)),
                            h.G && 1 == h.G.a && h.G.b == c && 2 == f.J && (f.M = !0)
                    }
                for (let t of q)
                    O(t);
    ...
    class A {
        ...
        R(a) {
            ...
            C || (C = new WeakSet);
            C.add(f);
            var l = !document.elementsFromPoint(0, 0).includes(f);
            if (e = l) {
                l = new Map;
                for (e = a; e; ) {
                    var m = c.b(e, "style");
    ...
    y.a = r;
    let ia;
    (D = window.___1071219476) ? D(y) : ia = y;
    p["default"] = ia
}
]);
